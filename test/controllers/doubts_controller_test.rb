...
class DoubtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doubt" do
    assert_difference('Doubt.count') do
      post doubts_url, params: { doubt: { description: @doubt.description, title: @doubt.title, user_id: @doubt.user_id } }
    end
  ...
  test "should update doubt" do
    patch doubt_url(@doubt), params: { doubt: { description: @doubt.description, title: @doubt.title, user_id: @doubt.user_id } }
